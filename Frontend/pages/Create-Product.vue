<template>
  <div class="container mx-auto pt-10">
    ...
    <div class="product__block">
      ...
      <input type="number" v-model.number="data.discountPercentag" class="product__input">
    </div>
    <div class="product__block">
      <p class="product__title">
        Rating
...
const validateFields = computed(() => {
  allInfo()
  return !(data.value.title && data.value.description && data.value.price && data.value.discountPercentag && data.value.rating && data.value.stock && data.value.brand && data.value.category && data.value.thumbnail && data.value.images[0])
})
